...
extension CellPlayVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell?.playButtonClickBlock = { [weak self] (sender) in
            var url = URL(string: ["https://me.guiji365.com/20180616/LQfzeEFU/index.m3u8","http://192.168.137.158:50004/storage/v_m3u8/e7adf3d34b1e8a22a08657655212a038/index.m3u8","http://api.gfs100.cn/upload/20180201/201802011423168057.mp4","http://api.gfs100.cn/upload/20171218/201712181643211975.mp4"][indexPath.row])
